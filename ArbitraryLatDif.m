function [difNHSH,NH,SH,MWA,MonthlySubtractedFluxes] = ArbitraryLatDif(permuteNet,time,LowerLat,HigherLat)
...
for j=1:time
    ...
    NH(j) = sum(latFluxes(lat > LowerLat & lat < HigherLat));
...
[AX,H1,H2] = plotyy(1:length(NHmoving_weighted_avg(12:end)),[NHmoving_weighted_avg(12:end)' SHmoving_weighted_avg(12:end)'],1:length(NHmoving_weighted_avg(12:end)),valid_moving_weighted_avg);
grid on;
set(gca,'xtick',[11:12:119+26])
set(gca,'XTickLabel',{2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013})
xlabel('Year end');
set(get(AX(1),'Ylabel'),'FontSize',20,'String','Heat Flux in Latitude Band for NH, SH (Watts)') 
set(get(AX(2),'Ylabel'),'FontSize',20,'String','NH-SH Difference in Total Heat Flux (Watts)','FontSize',20) 
