function Matrix = PlotIndexThresholdLower(Flux1,TimeSeries,Percentile,Var1,Var2)
...
title(['Avg monthly ',Var1,' departure when index of ',Var2,' is below ', num2str(Percentile),' Percentile. Mean = ', num2str(FluxMean)])
grid on;
set(gca,'GridLineStyle','--')
set(gcf,'paperposition',[0 0 20 10])
print(gcf,'-dpng','-r300',['Below',num2str(Percentile),'ThresholdMonDepar_',Var1,'-',Var2,'.png']);
hold off;
