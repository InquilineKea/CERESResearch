function GlobalCorrs = GlobalCorrMapVarNameInput(Flux1,Flux2,Var1,Var2)
...
caxis([-max(max(GlobalCorrs)) max(max(GlobalCorrs))])
MakeLizMap
colormap(lizmap)
title(['Correlation between ',Var1,' and ',Var2, '. Mean = ', num2str(CorrMean)])
set(gca,'GridLineStyle','--')
set(gcf,'paperposition',[0 0 20 10])
print(gcf,'-dpng','-r300',['GlobalCorr_',Var1,'-',Var2,'.png']);
hold off;
